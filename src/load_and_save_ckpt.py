...
pretrained_model='/home/thiago/gryfo/morecode/finetuning_sync/models/20180903-101744/model-20180903-101744.ckpt-1'
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        if pretrained_model:
            ...
            saver.restore(sess, pretrained_model2)
        epoch =1 
        save_variables_and_metagraph(sess, saver, summary_writer, 'models/model', subdir, epoch)
